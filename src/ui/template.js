        ...
        <div class="st_ai_settings_form">
            <div class="st_ai_field">
                ...
                <div class="st_ai_inline_row">
                    ...
                    <button type="button" id="st_gpt_preset_save" class="st_ai_btn" title="保存当前配置为预设" aria-label="保存当前配置为预设"><i class="fa-solid fa-floppy-disk"></i></button>
                    <button type="button" id="st_gpt_preset_delete" class="st_ai_btn" title="删除选中预设" aria-label="删除选中预设"><i class="fa-solid fa-trash"></i></button>
                </div>
            </div>
            <div class="st_ai_field">
